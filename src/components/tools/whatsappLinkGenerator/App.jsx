                        ...
                        <ul className='message-item-cont'>
                            <li className='message-li'>
                                <div className='message-icon'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="#0ab819" className="bi bi-whatsapp" viewBox="0 0 16 16">
                            ...
                            <li className='message-item message-li'>
                                <div className='message-icon'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="#1a202a" className="bi bi-chat-dots" viewBox="0 0 16 16">
